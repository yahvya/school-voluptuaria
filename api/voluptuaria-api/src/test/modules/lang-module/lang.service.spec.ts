...
describe("LangModule.LangService",() => {
    ...
    test
        .each([
            ...
            },
            {
                lang: "french",
                key: "message.welcome-user-intro",
                expectedValue: "Bienvenue sur notre plateforme Voluptuaria [Username]",
                replaces: {}
            },
            {
                lang: "french",
        ...
        ("translation in <$lang> for key <$key> with $expectedValue",({lang,key,expectedValue,replaces}) => {
    ...
    it("should throw an exception",async () => {
        expect(() => langService.translation({langFilename: "no_exist",key: "#"})).toThrow(LangServiceException)
    })
})
